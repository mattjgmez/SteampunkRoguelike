...
{
    [Header("Movement")]
    // If true, the projectile will rotate at PreInitialization toward its rotation.
    ...
    // If true, the spawner can change the object's direction. Otherwise will use the direction set in the Inspector.
    public bool DirectionChangedBySpawner = true;

    [Header("Spawn")]
    // Initial delay before object can be destroyed.
    public float InitialInvulnerabilityDuration = 0f;
    // Can the projectile damage its owner?
